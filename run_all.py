...
def build_email_summary(cfg):
    ...
    plain = (
        f"{cfg.get('client_display_name', 'CALL CENTER')} QA — REPORT SUMMARY\n"
...
<div style="background:#1f3864;padding:18px 24px;border-radius:6px 6px 0 0">
  <h2 style="color:#fff;margin:0">{cfg.get('client_display_name', 'Call Center')} QA Report</h2>
...
if __name__ == "__main__":
    ...
    print("\n" + "═" * 60)
    print(f"  {cfg.get('client_display_name', 'CALL CENTER')} QA PIPELINE")
